...
const RAW_QUESTION_TRAITS = {
  ...
  "¿Has secuestrado una conversación para convertirla en tu autobiografía express?": { NAR:4, DSC:1 },
  "¿Has inflado una historia hasta que parecía tráiler de Netflix?": { NAR:4, PAP:2 },
  "¿Has actuado como experto absoluto sin tener ni idea de nada?": { NAR:4, PAP:2 },
  "¿Has rematado un desastre con un “yo ya lo dije” en modo superioridad?": { NAR:4, RTS:2 },
  "¿Has prometido “una cosa rápida” y diste una TED Talk sin invitación?": { NAR:4, DSC:1 },
  ...
  "¿Has usado el móvil como escudo humano para huir de una charla incómoda?": { PAP:4, DSC:1 },
  ...
  "¿Has mandado “perdón por tardar” después de pasarte todo el día en línea?": { PAP:4, RTS:2 },
  "¿Has ejecutado un “ok.” cortante para matar una conversación incómoda?": { PAP:4, RTS:1 },
  ...
  "¿Has aplicado ghosting táctico esperando que el problema se autodestruya?": { PAP:4 },
  ...
  "¿Has dejado sonar una llamada a propósito para luego soltar un falso “¿todo bien?”?": { PAP:4, DSC:1 },

  // Torpeza social (DSC dominante)
  "¿Has cambiado de acera en maniobra cobarde para evitar saludar?": { DSC:4, PAP:2 },
  "¿Has saludado a alguien que no te estaba saludando a ti?": { DSC:4 },
  "¿Has intentado escapar de una charla y acabaste en bucle social sin salida?": { DSC:4, PAP:2 },
  "¿Has sostenido contacto visual un segundo de más hasta generar terror?": { DSC:4 },
  ...
  "¿Has intentado colarte en una fila con la sutileza de un villano barato?": { RTS:5 },
  "¿Has soltado “es un segundo” para justificar una molestia monumental?": { RTS:5 },
  ...
  "¿Has tirado basura pensando “total, esto ya era un vertedero”?": { RTS:5 },
  ...
  "¿Has activado el móvil con sonido en silencio absoluto porque “no pasará nada”?": { RTS:5 },
  "¿Has cogido sitio de más en el sofá como si fueras un emperador romano?": { RTS:4, DSC:1 },

  // Pasivo-agresivo (PAP dominante)
  "¿Has escrito un “qué pena” tan falso que ni tú te lo creíste?": { PAP:4 },
  "¿Has hecho un comentario sarcástico que no se entendió?": { PAP:4, TRL:1 },
  "¿Has lanzado una puñalada pasivo-agresiva con sonrisa diplomática?": { PAP:4 },
  "¿Has enviado un mensaje ambiguo para que otro lo interprete?": { PAP:4, RTS:2 },
  "¿Has dicho “qué ilusión verte” sin sentirlo?": { PAP:4 },
  "¿Has dicho “no pasa nada” mientras esperabas venganza emocional inmediata?": { PAP:4, RTS:2 },
  "¿Has disparado un “haz lo que quieras” esperando obediencia total?": { PAP:4, RTS:2 },
  ...
  "¿Has regalado un “te queda genial” en modo mentira piadosa premium?": { PAP:4 },
  ...
  "¿Has prometido “te aviso” sabiendo que jamás pensabas avisar?": { RTS:4, PAP:2 },
  ...
  "¿Has culpado al tráfico cuando el único atasco eras tú saliendo tarde?": { RTS:4, PAP:2 },
  ...
  "¿Has soltado “yo invito la próxima” esperando que prescribiera en el olvido?": { RTS:4, PAP:2 },
  ...
  "¿Has jurado “yo me encargo” y luego te evaporaste como humo?": { RTS:4, PAP:2 },
  ...
  "¿Has dicho “yo cero drama” justo antes de prender la mecha?": { TRL:4, PAP:1 },
  "¿Has hecho una broma a costa de alguien presente?": { TRL:4, PAP:2 },
  "¿Has soltado un chisme con el clásico “no debería contarlo, pero…”?": { TRL:4 },
  ...
  "¿Has echado gasolina al fuego y después actuado como testigo inocente?": { TRL:4, PAP:2 },
  ...
  "¿Has lanzado un “uff” en el chat solo para activar el caos colectivo?": { TRL:4, PAP:1 }
};
